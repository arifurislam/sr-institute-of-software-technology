    ...
    <div class="col-lg-12 p-r-0 title-margin-right">
        <div class="page-header">
            <div class="page-title">
                <span>Welcome Here, </span> <span> <b class="text-danger">Time {{$date->format('h: i: a  M-d')}}</b></span>
                <h3 >Total Contacts ({{$todayC}})</h3>
            </div>
        </div>
    </div>
</div>
