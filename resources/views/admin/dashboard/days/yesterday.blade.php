...
@section('title','yesterday-contact')
@push('css')
    ...
    <div class="col-lg-12 p-r-0 title-margin-right">
        <div class="page-header">
            <div class="page-title">
                <span>Welcome Here, </span> <span> <b class="text-danger">Dated : {{$date}} </b></span>
                <h3 >Total Contacts ({{$yesterdayC}})</h3>
            </div>
        </div>
    </div>
</div>
